...
public class Aresta implements org.apache.thrift.TBase<Aresta, Aresta._Fields>, java.io.Serializable, Cloneable, Comparable<Aresta> {
  ...
  private static final org.apache.thrift.protocol.TField VERTICE1_FIELD_DESC = new org.apache.thrift.protocol.TField("vertice1", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  private static final org.apache.thrift.protocol.TField VERTICE2_FIELD_DESC = new org.apache.thrift.protocol.TField("vertice2", org.apache.thrift.protocol.TType.STRUCT, (short)2);
  ...
  public Vertice vertice1; // required
  public Vertice vertice2; // required
  ...
  private static final int __DIREC_ISSET_ID = 1;
  ...
  public Aresta(Aresta other) {
    ...
    if (other.isSetVertice1()) {
      this.vertice1 = new Vertice(other.vertice1);
    }
    if (other.isSetVertice2()) {
      this.vertice2 = new Vertice(other.vertice2);
    }
  ...
  public Aresta setVertice1(Vertice vertice1) {
    this.vertice1 = vertice1;
    return this;
  }
  ...
  public Aresta setVertice2(Vertice vertice2) {
    this.vertice2 = vertice2;
    return this;
  }
  ...
  public boolean equals(Aresta that) {
    ...
    boolean this_present_vertice1 = true && this.isSetVertice1();
    boolean that_present_vertice1 = true && that.isSetVertice1();
    if (this_present_vertice1 || that_present_vertice1) {
      if (!(this_present_vertice1 && that_present_vertice1))
        return false;
      if (!this.vertice1.equals(that.vertice1))
        return false;
    }

    boolean this_present_vertice2 = true && this.isSetVertice2();
    boolean that_present_vertice2 = true && that.isSetVertice2();
    if (this_present_vertice2 || that_present_vertice2) {
      if (!(this_present_vertice2 && that_present_vertice2))
        return false;
      if (!this.vertice2.equals(that.vertice2))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetVertice1()) ? 131071 : 524287);
    if (isSetVertice1())
      hashCode = hashCode * 8191 + vertice1.hashCode();

    hashCode = hashCode * 8191 + ((isSetVertice2()) ? 131071 : 524287);
    if (isSetVertice2())
      hashCode = hashCode * 8191 + vertice2.hashCode();
  ...
  private static class ArestaStandardScheme extends org.apache.thrift.scheme.StandardScheme<Aresta> {
        ...
        switch (schemeField.id) {
          case 1: // VERTICE1
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.vertice1 = new Vertice();
              struct.vertice1.read(iprot);
          ...
          case 2: // VERTICE2
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.vertice2 = new Vertice();
              struct.vertice2.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Aresta struct) throws org.apache.thrift.TException {
      ...
      if (struct.vertice1 != null) {
        oprot.writeFieldBegin(VERTICE1_FIELD_DESC);
        struct.vertice1.write(oprot);
        oprot.writeFieldEnd();
      }
      if (struct.vertice2 != null) {
        oprot.writeFieldBegin(VERTICE2_FIELD_DESC);
        struct.vertice2.write(oprot);
        oprot.writeFieldEnd();
      }
