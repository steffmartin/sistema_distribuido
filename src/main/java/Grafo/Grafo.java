...
public class Grafo implements org.apache.thrift.TBase<Grafo, Grafo._Fields>, java.io.Serializable, Cloneable, Comparable<Grafo> {
  ...
  public java.util.Map<Id,Aresta> arestas; // required
  ...
  public Grafo() {
    ...
    this.arestas = new java.util.HashMap<Id,Aresta>();

  }

  public Grafo(
    java.util.Map<java.lang.Integer,Vertice> vertices,
    java.util.Map<Id,Aresta> arestas)
  {
    this();
  ...
  public Grafo(Grafo other) {
    ...
    if (other.isSetArestas()) {
      java.util.Map<Id,Aresta> __this__arestas = new java.util.HashMap<Id,Aresta>(other.arestas.size());
      for (java.util.Map.Entry<Id, Aresta> other_element : other.arestas.entrySet()) {
  ...
  public void putToArestas(Id key, Aresta val) {
  ...
  public java.util.Map<Id,Aresta> getArestas() {
    return this.arestas;
  }

  public Grafo setArestas(java.util.Map<Id,Aresta> arestas) {
    this.arestas = arestas;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ARESTAS:
      if (value == null) {
        ...
        setArestas((java.util.Map<Id,Aresta>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.arestas = new java.util.HashMap<Id,Aresta>(2*_map4.size);
                Id _key5;
                Aresta _val6;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Grafo struct) throws org.apache.thrift.TException {
      ...
      if (struct.arestas != null) {
        oprot.writeFieldBegin(ARESTAS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<Id, Aresta> _iter9 : struct.arestas.entrySet())
          {
      ...
      if (struct.isSetArestas()) {
        {
          ...
          for (java.util.Map.Entry<Id, Aresta> _iter11 : struct.arestas.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.arestas = new java.util.HashMap<Id,Aresta>(2*_map16.size);
          Id _key17;
          Aresta _val18;
